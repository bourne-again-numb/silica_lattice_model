...
700 format(I8,x,A) 
  ...
  subroutine rotate(ksite,kvertex,kspin,kmolecule,rings3,rings4,tot_en,AR)
    ...
    elseif(kspin.eq.spinSI)then
       ...
       oldTAAlinkage = TAAlink(oldSIlinkage)
       if(kvertex_new.eq.kvertex)return
    else
    ...
    write(400000,*)tot_en,old_en,new_en
    write(500000,*)rotation_attempted,rotation_accepted
...
900 format(i15)
  ...
  subroutine safetycheck(rings3,rings4,tot_en)
    ...
    write(200000,*)connectedSI,connectedTAA
